  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interval as @interval" do
        ...
        post :create, {:interval => { "name" => "invalid value" }}, valid_session
        assigns(:interval).should be_a_new(Interval)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interval" do
        ...
        Interval.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => interval.to_param, :interval => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the interval as @interval" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interval.any_instance.stub(:save).and_return(false)
        put :update, {:id => interval.to_param, :interval => { "name" => "invalid value" }}, valid_session
        assigns(:interval).should eq(interval)
      end
